                ...
                <div class="col-lg-6">
                    <div class="about-content about-content-3">
                        <div class="section-heading mb-35">
                            ...
                            <h2 class="section-title">Affordable Health Insurance For Pre-Existing Conditions</h2>
                            <p>Affordable health insurance for people with pre-existing conditions like hypertension,
                                diabetes, arthritis, and peptic ulcer</p>
                        </div>
                        <a href="{{ route('pages.enrollee') }}" class="site-btn transparent">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
