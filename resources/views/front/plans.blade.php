            ...
            <div class="row">
                    ...
                    <div class="about-thumb-wrap about-thumb-wrap-3 mt-60">
                        <div class="about-thumb-big">
                            <div class="about-thumb-small">
                                <img src="assets/images/uploads/brave.jpg" alt="">
                            </div>
                            <img src="assets/images/uploads/family.jpg" alt="" style="width: 350px;height: 350px;">
                            <span class="shape">
                ...
                <div class="col-lg-6">
                    <div class="about-content about-content-3">
                        ...
                        <a href="{{ route('pages.individual') }}#pricing" class="site-btn transparent">Buy Now</a>
                    </div>
                </div>
            </div>
        </div>
