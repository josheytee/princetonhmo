                ...
                <div class="col-lg-12">
                    ...
                    <div class="about-content about-content-3">
                        <div class="section-heading mb-35">
                            ...
                            <h2 class="section-title">Hospitals in Nigeria that work with us</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product_weight">ABIA</td>
                                <td class="product_weight">NEW ERA HOSPITAL LIMITED</td>
                                <td class="product_weight">213/215 NNAMDI AZIKWE ROAD, ABIA</td>
                            </tr>
                            <tr>
                                <td class="product_weight">1</td>
                                <td class="product_weight">ABIA</td>
